...
public class ModifMenu extends javax.swing.JFrame {
    ...
    public ModifMenu() {
        ...
        SessionRestoTunisie.listedesPlatsTMP= new PlatDAO().displayPlayByMenu(SessionRestoTunisie.crtMenu.getId());
        jTextField1.setText(SessionRestoTunisie.crtMenu.getNom());
        jTextArea1.setText(SessionRestoTunisie.crtMenu.getDescription());
    }
    ...
    private void initComponents() {
        ...
        title.setText("Modifier ce Menu");
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/esprit/rt/images/modif001.png"))); // NOI18N
        jLabel7.setText("Modifier le menu");
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ...
        m.setId(SessionRestoTunisie.crtMenu.getId());
        new MenuDAO().updateMenu(m);
        for (Plat p : SessionRestoTunisie.listedesPlatsTMP)
        {
            new PlatDAO().deleteIt(p);
            new PlatDAO().insert(p);
        }
       new FlatosDialogos(this, "Menu modifié!", 20f, true).setVisible(true);
